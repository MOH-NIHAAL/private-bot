...
async def advantage_spoll_choker(bot, query):
    ...
    if int(user) != 0 and query.from_user.id != int(user):
        return await query.answer("𝖲𝖾𝖺𝗋𝖼𝗁 𝖸𝗈𝗎𝗋𝗌𝖾𝗅𝖿 𝖡𝗋𝗈 😌", show_alert=True)
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('𝖢𝖺𝗇𝗍 𝖥𝗂𝗇𝖽 𝖨𝗇 𝗆𝗒 𝖣𝖺𝗍𝖺𝖡𝖺𝗌𝖾.')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url='https://t.me/+LqHpKVf0p9ZiNDI1'),
            InlineKeyboardButton('ᴍᴏᴠɪᴇs', url='https://t.me/+SQeX51RDfsMzMWFl'),
